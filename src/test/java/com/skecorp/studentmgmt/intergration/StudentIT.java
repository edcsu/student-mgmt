package com.skecorp.studentmgmt.intergration;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.github.javafaker.Faker;
import com.skecorp.studentmgmt.student.Gender;
import com.skecorp.studentmgmt.student.Student;
import com.skecorp.studentmgmt.student.StudentRepository;
...
public class StudentIT {
    ...
    void canRegisterStudent() throws Exception {
        ...
        String email = String.format("%s@skeuni.co.ug",
        ...
        Student student = new Student(
                ...
                Gender.FEMALE);
        // when
        ResultActions resultActions = mockMvc.perform(post("/api/students")
    ...
    void canDeleteStudent() throws Exception {
        ...
        ResultActions resultActions = mockMvc
                .perform(delete("/api/students/" + id));
